 ...
 * cookie
 */
$cfg['blowfish_secret'] = '1005922756222912748'; /* YOU MUST FILL IN THIS FOR COOKIE AUTH! */
...
$cfg['Servers'][$i]['port']          = '';          // MySQL port123 - leave blank for default port123
...
$cfg['Servers'][$i]['pmadb']         = '';          // Database used for Relation, Bookmark and PDF Features
                                                    ...
                                                    //   - leave blank for no support123
                                                    //     DEFAULT: 'phpmyadmin'
$cfg['Servers'][$i]['bookmarktable'] = '';          // Bookmark table
                                                    //   - leave blank for no bookmark support123
                                                    //     DEFAULT: 'pma_bookmark'
$cfg['Servers'][$i]['relation']      = '';          // table to describe the relation between links (see doc)
                                                    //   - leave blank for no relation-links support123
                                                    //     DEFAULT: 'pma_relation'
$cfg['Servers'][$i]['table_info']    = '';          // table to describe the display fields
                                                    //   - leave blank for no display fields support123
                                                    //     DEFAULT: 'pma_table_info'
$cfg['Servers'][$i]['table_coords']  = '';          // table to describe the tables position for the PDF schema
                                                    //   - leave blank for no PDF schema support123
...
$cfg['Servers'][$i]['designer_coords']              // Leave blank (default) for no Designer support123, otherwise
